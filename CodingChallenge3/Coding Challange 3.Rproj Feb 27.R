...
Mycotoxin_Data <- read.csv("MycotoxinData.csv", na.strings = "na") # Load dataset of MycotoxinData


str(Mycotoxin_Data_data)   # structure of the dataframe
...
### Answer: If we use common legend function then we don't need to assign the same legend for every plot.
